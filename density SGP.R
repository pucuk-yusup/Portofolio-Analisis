...
#Get Data Singapore
url<-"https://data.worldpop.org/GIS/Population/Global_2021_2022_1km_UNadj/constrained/2022/SGP/sgp_ppp_2022_1km_UNadj_constrained.tif"
...
# Perbaiki plot dengan geom_tile()
map2 <- ggplot() +
  geom_tile(
    data = populationdf,
